/*
Deployment script for javascript1_db
...
GO
:setvar DatabaseName "javascript1_db"
:setvar DefaultFilePrefix "javascript1_db"
...
BEGIN TRANSACTION
GO
PRINT N'Dropping [dotnet2].[__MigrationHistory]...';
